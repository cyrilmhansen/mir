...
static MIR_item_t rnd_proto, rnd_import, chr_proto, chr_import, string_proto, string_import,
  ...
  exp_import, fact_proto, fact_import, left_proto, left_import, right_proto, right_import,
  mid_proto, mid_import, len_proto, len_import, val_proto, val_import, str_proto, str_import,
...
static const Builtin builtins[]
  = {{"RND", 0},        {"INT", 0},     {"TIMER", 0},     {"TIME", 0},     {"DATE", 0},
     ...
     {"LOG", 0},        {"LOG2", 0},    {"LOG10", 0},     {"EXP", 0},      {"FACT", 0},
