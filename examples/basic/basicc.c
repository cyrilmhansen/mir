...
static MIR_item_t rnd_proto, rnd_import, chr_proto, chr_import, string_proto, string_import,
  ...
  atn_import, sinh_proto, sinh_import, cosh_proto, cosh_import, tanh_proto, tanh_import,
  asinh_proto, asinh_import, acosh_proto, acosh_import, atanh_proto, atanh_import, log_proto,
  log_import, log2_proto, log2_import, log10_proto, log10_import, exp_proto, exp_import, left_proto,
  ...
  instr_import, strdup_proto, strdup_import, mir_ctx_proto, mir_ctx_import, mir_mod_proto,
  mir_mod_import, mir_func_proto, mir_func_import, mir_reg_proto, mir_reg_import, mir_label_proto,
  mir_label_import, mir_emit_proto, mir_emit_import, mir_emitlbl_proto, mir_emitlbl_import,
  mir_ret_proto, mir_ret_import, mir_finish_proto, mir_finish_import, mir_run_proto, mir_run_import,
...
static const Builtin builtins[]
  = {{"RND", 0},        {"INT", 0},     {"TIMER", 0},     {"TIME", 0},     {"DATE", 0},
     ...
     {"ATANH", 0},      {"LOG", 0},     {"LOG2", 0},      {"LOG10", 0},    {"EXP", 0},
     {"LEN", 0},        {"VAL", 0},     {"ASC", 0},       {"INSTR", 0},    {"MIRCTX", 0},
     {"MIRMOD", 0},     {"MIRFUNC", 0}, {"MIRREG", 0},    {"MIRLABEL", 0}, {"MIREMIT", 0},
     {"MIREMITLBL", 0}, {"MIRRET", 0},  {"MIRFINISH", 0}, {"MIRRUN", 0},   {"MIRDUMP", 0},
     {"CHR$", 1},       {"STRING$", 1}, {"TIME$", 1},     {"DATE$", 1},    {"INPUT$", 1},
     {"SPC", 1},        {"TAB", 0},     {"LEFT$", 1},     {"RIGHT$", 1},   {"MID$", 1},
