...
static void gen_stmt_default (Stmt *s) {
  ...
  case ST_OPEN: {
    ...
    safe_snprintf (buf, sizeof (buf), "$t%d", tmp_id++);
    MIR_reg_t fni = MIR_new_func_reg (g_ctx, g_func->u.func, MIR_T_I64, buf);
    basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, fni),
                             MIR_new_reg_op (g_ctx, fn));
  ...
  case ST_SCREEN: {
    ...
    basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, mi), MIR_new_reg_op (g_ctx, m));
    MIR_append_insn (g_ctx, g_func,
  ...
  case ST_COLOR: {
    ...
    basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, ci), MIR_new_reg_op (g_ctx, c));
    MIR_append_insn (g_ctx, g_func,
  ...
  case ST_LOCATE: {
    ...
    basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, ri), MIR_new_reg_op (g_ctx, r));
    safe_snprintf (buf, sizeof (buf), "$t%d", tmp_id++);
    MIR_reg_t ci = MIR_new_func_reg (g_ctx, g_func->u.func, MIR_T_I64, buf);
    basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, ci), MIR_new_reg_op (g_ctx, c));
    MIR_append_insn (g_ctx, g_func,
  ...
  case ST_NEXT: {
    ...
    basic_num_hooks.mir_binop (g_ctx, g_func, MIR_DADD, MIR_new_reg_op (g_ctx, info.var),
  ...
  case ST_WHILE: {
    ...
    basic_num_hooks.mir_bcmp (g_ctx, g_func, MIR_DBEQ, MIR_new_label_op (g_ctx, end_label),
  ...
  case ST_UNTIL: {
    ...
    MIR_reg_t cond = gen_expr (g_ctx, g_func, &g_vars, s->u.expr);
    basic_num_hooks.mir_bcmp (g_ctx, g_func, MIR_DBEQ, MIR_new_label_op (g_ctx, info.start_label),
                              MIR_new_reg_op (g_ctx, cond), emit_num_const (g_ctx, BASIC_ZERO));
    MIR_append_insn (g_ctx, g_func, info.end_label);
    break;
  }
  ...
  case ST_DEC: {
    ...
    basic_num_hooks.mir_binop (g_ctx, g_func, ic, MIR_new_reg_op (g_ctx, v),
  ...
  case ST_IF: {
    ...
    basic_num_hooks.mir_bcmp (g_ctx, g_func, MIR_DBEQ, MIR_new_label_op (g_ctx, next),
    ...
    for (size_t i = 0; i < n; i++) {
      ...
      basic_num_hooks.mir_bcmp (g_ctx, g_func, MIR_DBEQ, MIR_new_label_op (g_ctx, next2),
  ...
  case ST_DELAY: {
    ...
    basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, msi),
  ...
  case ST_DIM: {
    for (size_t k = 0; k < s->u.dim.n; k++) {
      ...
      basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, size1),
      ...
      if (s->u.dim.sizes2[k] != NULL) {
        ...
        basic_num_hooks.mir_n2i (g_ctx, g_func, MIR_new_reg_op (g_ctx, size2),
