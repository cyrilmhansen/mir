...
/* No error is possible.					      */
/* ------------------------------------------------------------------ */
uInt decContextGetStatus (decContext *context) { return context->status; } /* decContextGetStatus */
...
/* No error is possible.					      */
/* ------------------------------------------------------------------ */
decContext *decContextRestoreStatus (decContext *context, uInt newstatus, uInt mask) {
...
decContext *decContextSetStatusFromString (decContext *context, const char *string) {
  ...
  if (strcmp (string, DEC_Condition_ZE) == 0) return context;
...
/*    returned. 						      */
/* ------------------------------------------------------------------ */
decContext *decContextSetStatusFromStringQuiet (decContext *context, const char *string) {
  if (strcmp (string, DEC_Condition_CS) == 0)
